        ...
        <div className="lg:col-span-7 bg-white border-2 border-[#000000] rounded-2xl p-6 sm:p-8 shadow-[6px_8px_0px_#232141]">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              {/* Error Banner */}
              {errorMessage && (
                <div className="p-3 bg-[#ffebeb] border border-[#ff5555] rounded-xl text-xs text-[#cc0000] font-semibold">
                  {errorMessage}
                </div>
              )}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#5f58d6] text-white border-2 border-[#000000] py-3 rounded-xl font-bold text-xs sm:text-sm shadow-[3px_4px_0px_#000000] hover:bg-[#4a44b8] transition-all mt-1 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
